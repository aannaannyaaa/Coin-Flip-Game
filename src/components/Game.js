...
export const Game = () => {
  ...
  return (
    <>
      ...
      <p>Ready to win double? Enter your bet amount and choose your side! Good luck!</p>
      <p
        style={{
          fontStyle: "italic",
          fontSize: "0.7em",
      ...
      >
        Note: the result might take up to a few minutes. Just go grab a chai and relax, you will get notified once the
        flip is over.
      </p>
      <p>
